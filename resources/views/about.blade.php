...
<head>
    <meta charset="utf-8">
    <title>Thehungerproject about page</title>
    ...
    <div class="container-fluid sticky-top bg-dark bg-light-radial shadow-sm px-5 pe-lg-0">
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            <a href="index.html" class="navbar-brand">
                <h2 class="m-0 display-4 text-uppercase text-white"><i class="bi bi-building text-primary me-2"></i>Thehungerproject</h2>
            </a>
		...
		<p class="mb-4">We are optimistic about bringing to an end the issue of hunger. will help in contributing to that agender before 2030 mainly in the the agricultural aspect with the widely available open-data and partnership.</p>
            ...
            <div class="col-lg-5 pb-5" style="min-height: 400px;">
                <div class="position-relative bg-dark-radial h-100 ms-5">
                    <img class="position-absolute w-100 h-100 mt-5 ms-n5" src="img/2_SDG_MakeEveryDayCount_Gifs_GDU.gif" style="object-fit: cove;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4">We Are <span class="text-primary">alx & Code-Plateau </span>Software Engineering Students</h1>
        </div>
        <div class="row g-5">
                ...
                <div class="row g-0">
                    <div class="col-10" style="min-height: 300px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="img/devhendrixx.png" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="h-100 d-flex flex-column align-items-center justify-content-between bg-light">
                            <a class="btn" href="https://twitter.com/HendrixxSdiddy"><i class="fab fa-twitter"></i></a>
                            <a class="btn" href="https://web.facebook.com/?_rdc=1&_rdr"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn" href="https://www.linkedin.com/in/lenge-dandung-joshua-949439229/"><i class="fab fa-linkedin-in"></i></a>
                            <a class="btn" href="https://github.com/hendrixxD"><i class="fab fa-github"></i></a>
                            <a class="btn" href=""><i class="fab fa-medium"></i></a>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="bg-light p-4">
                            <h4 class="text-uppercase">Lenge Dandung Joshua</h4>
                            <span>alx/Code-Plateau Software Engineering sttudent</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    ...
                    <div class="col-12">
                        <div class="bg-light p-4">
                            <h4 class="text-uppercase">Dashe auwal</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    <div class="col-10" style="min-height: 300px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="img/.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="h-100 d-flex flex-column align-items-center justify-content-between bg-light">
                    ...
                    <div class="col-12">
                        <div class="bg-light p-4">
                            <h4 class="text-uppercase">Ebube Ephraim</h4>
                            <span>Software engineer</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    ...
                    <div class="col-12">
                        <div class="bg-light p-4">
                            <h4 class="text-uppercase">Daniel Dan</h4>
			    <span>Software Engineer</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer container-fluid position-relative bg-dark bg-light-radial text-white-50 py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-6 pe-lg-5">
                <a href="index.html" class="navbar-brand">
                    <h3 class="m-0 display-4 text-uppercase text-white"><i class="bi bi-building text-primary me-2"></i>Thehungerproject</h3>
                </a>
                <p>An important step towards solving the SDG goal-2(ZeroHunger) is to allow farmers unrestricted access to agricultural big data, we aim to acheive this through</p>
                <p><i class="fa fa-map-marker-alt me-2"></i>Code-plateau campus, No.11 Dagwom du way</p>
                <p><i class="fa fa-phone-alt me-2"></i>+2348101213083</p>
                <p><i class="fa fa-envelope me-2"></i>Thehungerproject@gmail.com</p>
    ...
    <div class="container-fluid bg-dark bg-light-radial text-white border-top border-primary px-0">
        <div class="d-flex flex-column flex-md-row justify-content-between">
            <div class="py-4 px-5 text-center text-md-start">
                <p class="mb-0">&copy; <a class="text-primary" href="#">Thehungerproject</a>. All Rights Reserved.</p>
            </div>
            <div class="py-4 px-5 bg-primary footer-shape position-relative text-center text-md-end">
                <p class="mb-0">Designed by <a class="text-dark" href="https://htmlcodex.com">HTML Codex</a></p>
		<p class="mb-0">Modified by <a class="text-dark" href="">Thehungerproject</a></p>
            </div>
        </div>
    </div>
    <!-- Footer End -->
